...
<p align="center">
  <a href="https://github.com/izumedonabe/spine-codex-app/releases/download/v0.2.2.3/SpineCodex-App-v0.2.2.3-macos-arm64.dmg"><strong>下载 Apple Silicon 版本</strong></a>
  &nbsp;·&nbsp;
  <a href="https://github.com/izumedonabe/spine-codex-app/releases/download/v0.2.2.3/SpineCodex-App-v0.2.2.3-macos-x64.dmg"><strong>下载 Intel Mac 版本</strong></a>
  &nbsp;·&nbsp;
...
版本前三段跟踪最低支持的 SpineCodex 版本，第四段表示仅包装层修订。本版本为 **v0.2.2.3**，最低仍要求 SpineCodex 0.2.2。版本跟踪不代表本仓库重新分发 SpineCodex。
