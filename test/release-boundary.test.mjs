...
test("wrapper 26.901.51231.1 separates minimum, recommended, and compatibility identities", () => {
  assert.equal(metadata.version, "26.901.51231");
  assert.equal(metadata.spineAppVersion, "26.901.51231.1");
  ...
  assert.match(launcher, /APP_VERSION = "26\.901\.51231\.1"/);
  ...
  assert.match(renderer, /VERSION = "26\.901\.51231\.1"/);
